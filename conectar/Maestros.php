...
<body class="body">
    <nav class="navbar navbar-light" style="background-color: #acd8f6;">
        <table style="width:100%;">
          ...
          <tr align="center">
            <td width="9%"><a href="javascript:if (confirm('¿Quieres cerrar session?')) {parent.location='Maestros.php?cerrar=1';};">Cerrar Sesion</a></td>
          </tr>
        </table>
    </nav>
    <br>
    <br>
        <div class="col mb-4">
            <div class="card">
                ...
                <div id="ocultable"><iframe src="CrearClase.php" width="600" height="200"></iframe></div>
        </div>
    </div>
        <hr>
        <div >
